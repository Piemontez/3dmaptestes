! function() {
    ...
    class OSMBuildings {
        ...
        _updateAttribution() {
            const e = [];
            this.attribution && e.push(this.attribution), this._attribution.innerHTML = e.join(" Â· ")
        }
        _getStateFromUrl() {
    ...
    OSMBuildings.VERSION = null, OSMBuildings.ATTRIBUTION = '<a href="https://osmbuildings.org/">Â© OSM Buildings</a>', "function" == typeof define ? define([], OSMBuildings) : "object" == typeof module ? module.exports = OSMBuildings : window.OSMBuildings = OSMBuildings;
    class Events {
        constructor(e) {
    ...
    class View {
        ...
        setupViewport() {
            ...
            this.nearPlane = 1, this.farPlane = 10000, this.projMatrix = (new GLX.Matrix).translateTo(0, -n / (2 * e), 0).scale(1, -1, 1).multiply(new GLX.Matrix.Perspective(i, t / n, this.nearPlane, this.farPlane)).translateBy(0, -1, 0), this.viewProjMatrix = new GLX.Matrix(GLX.Matrix.multiply(this.viewMatrix, this.projMatrix)), this.lowerLeftOnMap = getIntersectionWithXYPlane(-1, -1, GLX.Matrix.invert(this.viewProjMatrix.data)), void 0 !== this.lowerLeftOnMap && (this.fogDistance = 500000, this.fogBlurDistance = 1e4)
        }
        speedUp() {
